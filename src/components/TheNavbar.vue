          ...
          <router-link to="/client" @mouseenter="setHoveredItem({ id: 'history', position: 140 })"
            ...
            <div
              ...
              <a href="#"
                ...
                <span class="group-hover/item:text-teal-300 transition-colors">Progress Report</span>
              </a>
          ...
          <router-link to="/provider" @mouseenter="setHoveredItem({ id: 'hours', position: 260 })"
            ...
            <div
              ...
              <a href="#"
                ...
                <span class="group-hover/item:text-teal-300 transition-colors">Calendar</span>
              </a>

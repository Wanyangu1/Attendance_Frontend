      ...
      <div class="flex flex-col md:flex-row md:items-center gap-5">
        ...
        <div class="flex-shrink-0">
          <router-link to="/settings">
            <button
              class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5"
            >
      ...
      >
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div class="animate-fade-in-up">
            ...
            >
              <span class="inline-flex items-center">
                <svg
                  class="w-8 h-6 mr-3 text-indigo-500"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div class="animate-fade-in-up animation-delay-100">
            ...
            >
              <svg
                class="h-4 w-4 mr-2 text-blue-500 animate-pulse"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
      ...
      <div class="px-8 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          <div class="flex items-start mb-6">
            <div
              class="bg-gradient-to-br from-blue-100 to-blue-50 p-3 rounded-xl mr-4 shadow-inner"
            >
              <svg
          ...
          <div class="space-y-5">
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-5 items-start group">
              ...
              <p
                class="text-sm text-gray-800 sm:col-span-3 font-medium group-hover:text-blue-600 transition-colors"
              >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-5 items-start group">
              ...
              <p
                class="text-sm text-gray-500 sm:col-span-3 italic group-hover:text-blue-500 transition-colors"
              >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-5 items-start group">
              ...
              >
                <template
                  v-if="employee.address.city && employee.address.state && employee.address.zip"
                >
        ...
        <div class="space-y-6">
          ...
          >
            <div class="flex items-start mb-6">
              <div
                class="bg-gradient-to-br from-indigo-100 to-indigo-50 p-3 rounded-xl mr-4 shadow-inner"
              >
                <svg
          ...
          >
            <div class="flex items-start mb-6">
              <div
                class="bg-gradient-to-br from-purple-100 to-purple-50 p-3 rounded-xl mr-4 shadow-inner"
              >
                <svg
            ...
            <div class="space-y-5">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-5 items-start group">
                ...
                >
                  <template
                    v-if="employee.employment.payPeriodStart && employee.employment.payPeriodEnd"
                  >

          ...
          <div class="max-w-md mx-auto">
            <div class="flex items-center mb-8">
              ...
              <h2
                ...
                Create New Employee Account</h2>
            </div>

            <h1 class="text-4xl font-bold mb-6 leading-tight">Serving Our Community Together</h1>
            <p class="text-lg text-blue-100 mb-10">Your dedication to community health makes a difference every day.
              This portal helps you focus on what matters most.</p>

            <div class="space-y-6">
              <div
                class="flex items-start bg-white/10 backdrop-blur-sm p-5 rounded-xl border border-white/20 hover:border-white/30 transition-all">
                ...
                <div>
                  ...
                  <p class="text-blue-100">Track your hours contributing to vital health services</p>
                </div>
              </div>
              ...
              <div
                ...
                <div>
                  ...
                  <p class="text-blue-100">Patient privacy protected with enterprise-grade security</p>
                </div>
              </div>
      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:8">
        <div
          ...
          <div class="flex flex-col items-center mb-8">
            ...
            <p class="text-gray-600 mt-2 text-center">Register to access the employee portal for City Radius Community
              Health Services</p>
          </div>
          ...
          <form @submit.prevent="signup" class="space-y-6">
            <div class="space-y-5">
              ...
              <div>
                ...
                <div class="mt-2 flex items-center text-xs text-gray-500">
                  ...
                  <span>Minimum 12 characters with uppercase, number, and special character</span>
                </div>
              </div>
            </div>
            ...
            <!-- Error Message -->
            <div v-if="authError"
              class="p-4 rounded-lg bg-red-50 border border-red-200 text-red-700 flex items-start animate-fade-in">
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                <label for="terms" class="text-gray-700">
                  As an ADMIN, I agree to the <a href="#" class="text-[#0369a1] hover:underline font-medium">terms of
                    service</a> and

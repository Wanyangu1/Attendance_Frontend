      ...
      <div class="bg-white shadow rounded-lg p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select v-model="selectedDepartment" class="w-full rounded-md border-gray-300 shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
              <button @click="exportToExcel" class="text-sm text-blue-600 hover:text-blue-800 flex items-center">
              ...
              <tr v-for="record in filteredRecords" :key="record.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  <div class="flex items-center">
                    ...
                    <span v-if="record.late" class="ml-2 px-2 py-0.5 text-xs rounded-full bg-yellow-100 text-yellow-800">
                      Late
                    </span>
                  </div>
                </td>
                    ...
                    <div class="w-24 mr-2">
                      <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-blue-600 h-2 rounded-full" 
                             :style="{ width: `${Math.min(100, (record.biweekly_hours / 80) * 100)}%` }"></div>
                      </div>
                    </div>
                    <span class="text-xs text-gray-500">{{ formatHours(record.biweekly_hours) }} / 80h</span>
                  </div>
                </td>
              </tr>
            </tbody>
          ...
          <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p class="text-sm text-gray-700">
                ...
                <span class="font-medium">{{ Math.min(currentPage * pageSize, filteredRecords.length) }}</span> of 
